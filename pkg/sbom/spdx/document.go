...
func LoadDocument(b []byte) (Document, error) {
	doc23, err := spdx_json.Load2_3(bytes.NewReader(b))
	if err == nil && doc23 != nil {
		return documentFromSPDX(doc23)
	}
	doc23, err = spdx_rdf.Load2_3(bytes.NewReader(b))
	if err == nil && doc23 != nil {
		return documentFromSPDX(doc23)
	}
	doc23, err = spdx_tv.Load2_3(bytes.NewReader(b))
	if err == nil && doc23 != nil {
		return documentFromSPDX(doc23)
	}

	doc22, err := spdx_json.Load2_2(bytes.NewReader(b))
	if err == nil && doc22 != nil {
		return documentFromSPDX(doc22)
	}
	doc22, err = spdx_rdf.Load2_2(bytes.NewReader(b))
	if err == nil && doc22 != nil {
		return documentFromSPDX(doc22)
	}
	doc22, err = spdx_tv.Load2_2(bytes.NewReader(b))
	if err == nil && doc22 != nil {
		return documentFromSPDX(doc22)
	}
...
func (d *Document_22) GetName() string {
...
func (d *Document_23) GetName() string {
	return d.DocumentName
}
